(function () {
    ...
    function Collection(data) {
      ...
      this.build = function () {
        ...
        this.item.find('.luno-collection-card__views').text(Lampa.Utils.bigNumberToShort(data.views));
